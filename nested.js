    ...
    if (isLeft === 'depositories') {
        ...
        ev.target.appendChild(element);
         ...
         if(data === 'drag2' && element.parentNode.classList.value === 'block') {
             ...
             element.innerHTML =`<div class='col-md-4 col-xs-12'>
             <div class="grid-stack-item" data-gs-width="4" data-gs-height="1"><div class="grid-stack-item-content">
             1</div></div></div>`;
             return element;
         }
        if(data === 'drag2' && element.parentNode.id ==='frame') {
            element.classList.add("block");
            element.innerHTML =`<div class='grid-stack'><div class='col-md-4 col-xs-12'>
            <div class="grid-stack-item" data-gs-width="4" data-gs-height="1"><div class="grid-stack-item-content">
            1</div></div></div></div>`;
            return element;
        }
